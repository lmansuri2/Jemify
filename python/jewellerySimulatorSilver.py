...
jewellery = Image.open(r"C:\Users\user\Documents\jemifyProject\Jemify\images\SilverDropEarrings.png")
...
def beadonCanvas():
    ...
    createBead1 = jewelleryCanvas.create_image(169, 245, image=beadNew)
...
def charmonCanvas():
    ...
    createCharm1 = jewelleryCanvas.create_image(169, 245, image=charmNew)
